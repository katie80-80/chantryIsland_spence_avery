<?php
	function getCopy($filter, $postition){
		require_once('connect.php');
		$copystring = "SELECT * FROM tbl_copy WHERE copy_page = {$filter} and copy_position={$postition}";
	...
	function editCopy($filter, $postition, $copy){
		require_once('connect.php');
